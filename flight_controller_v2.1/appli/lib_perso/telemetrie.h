...
//Envoi moteurs
void TELEMETRIE_send_moteur_2b(int32_t int_16, uint8_t id_moteur, uart_struct_e * uart);		//On envoit la valeur du signal moteur sur deux octects pour la conserver tel quelle
void TELEMETRIE_send_moteur_1b(int32_t int_32, uint8_t id_moteur, uart_struct_e * uart);		//On envoi sur un octect donc par rapport à la valeur d'origine on fait - 1000 / 4 pour avoir un truc entre 0 et 250
...
//Envoi channels
void TELEMETRIE_send_channel_1b(int32_t int_32, uint8_t id_channel, uart_struct_e * uart);		//On envoi sur un octect donc par rapport à la valeur d'origine on fait - 1000 / 4 pour avoir un truc entre 0 et 250
void TELEMETRIE_send_channel_2b(int32_t int_32, uint8_t id_channel, uart_struct_e * uart);		//On envoit sur 2 octects pour préserver la valeur d'origine (si besoin de debug par ex)
...
void TELEMETRIE_send_gps(double latitude, double longitude, uart_struct_e * uart);
