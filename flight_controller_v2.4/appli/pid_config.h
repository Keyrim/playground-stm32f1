...
//Second order settings for lvled mode (values found in google sheet)
...
double PID_SETTINGS_YAW_ACCRO[8] = {2, 0, 0, PID_ANGLE_RATE, 250, 0.2, 0.5, 0};
