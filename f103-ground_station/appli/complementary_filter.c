...
void COMP_FILTER_update_angles(COMP_FILTER_angles_e* angles){
	...
	angles->x_acc = (double)angles->raw_data_mpu->Accelerometer_X / angles->acc_sensi ;
	angles->y_acc = (double)angles->raw_data_mpu->Accelerometer_Y / angles->acc_sensi ;
	angles->z_acc = (double)angles->raw_data_mpu->Accelerometer_Z / angles->acc_sensi ;
	...
	//Otherwise, we use the gyro
		...
		angles->x_gyro = (double)angles->raw_data_mpu->Gyroscope_X / ((double)angles->frequency * angles->gyro_sensi );
		angles->y_gyro = (double)angles->raw_data_mpu->Gyroscope_Y / ((double)angles->frequency * angles->gyro_sensi );
		angles->z_gyro = (double)angles->raw_data_mpu->Gyroscope_Z / ((double)angles->frequency * angles->gyro_sensi );
